...
export default function Sidebar() {
    ...
    return (
        <div className="fixed left-0 top-0 h-screen w-16 border-r border-white/5 flex flex-col justify-center items-center space-y-6 z-40 bg-black/20 backdrop-blur-sm">
