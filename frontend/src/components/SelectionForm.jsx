...
• Future AI researcher"
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-[#0a0a1a] via-[#1a1a3a] to-[#0a0a1a] flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <AnimatedRocket isLaunching={isLaunching} onComplete={handleLaunchComplete} />
                    ...
                    <div className="flex justify-between mt-4">
                        {[1, 2, 3, 4, 5, 6].map(step => (
                            <button
                                ...
                                className={`w-10 h-10 rounded-full text-sm font-bold transition-all duration-500 flex items-center justify-center ${
                                    step === currentStep 
                ...
                <div className="flex gap-4 mt-6">
                    ...
                    {currentStep < totalSteps ? (
                        <button
                            onClick={handleNext}
                            disabled={!canProceed()}
                            className={`flex-1 py-4 px-6 font-bold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 group ${
                                canProceed()
                        ...
                        <button
                            ...
                            className={`flex-1 py-4 px-6 font-black text-lg rounded-xl transition-all duration-300 flex items-center justify-center gap-3 ${
                                isGenerating 
